...
namespace otomasyon
{
    public partial class frm_urunler_guncelle : Form
    {
        public int kul_id;
        public frm_urunler_guncelle()
        {
            InitializeComponent();
        }

        private void frm_urunler_guncelle_Load(object sender, EventArgs e)
        {
            MessageBox.Show(kul_id.ToString());

            string sql = " select * from urun where u_id=" + kul_id;
        ...
        {
            string sql = " update urun set u_kat_id='" + Convert.ToInt32(cb_kategori.SelectedValue) + "', " +
                         " u_adi='" + txt_ad.Text + "' , u_aciklama='" + txt_aciklama.Text + "',  " +
                         " u_fiyat='" + txt_fiyat.Text + "' where u_id=" + kul_id;
        ...
        private void frm_urunler_guncelle_Activated(object sender, EventArgs e)
        {
