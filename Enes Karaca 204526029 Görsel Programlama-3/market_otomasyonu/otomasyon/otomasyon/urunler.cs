    ...
    public partial class urunler : Form
    {
        ...
        public void fnk_liste_doldur()
        {
            string sql = " select u_id as 'Ürün Kodu', kat_adi as 'Kategori',  " +
                         " u_adi as 'Ürün Adı', u_aciklama 'Ürün Açıklama', u_fiyat as 'Fiyatı' " +
                         " from   urun  " +
                         " left join kategori on urun.u_kat_id=kategori.kat_id order by u_id desc ";
            SqlConnection baglan = new SqlConnection(Form1.baglanti);
            baglan.Open();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string sql_text = "insert into urun values('"+Convert.ToInt32( cb_kategori.SelectedValue)+"','"+txt_ad.Text+ "','" + txt_aciklama.Text + "','" + txt_fiyat.Text+ "')";
        ...
        private void güncelleToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frm_urunler_guncelle gun = new frm_urunler_guncelle();
            gun.kul_id = id;
            gun.ShowDialog();
            fnk_liste_doldur();
        }
        ...
        private void silToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (mesaj == DialogResult.Yes)
            {
                ...
                string sql = " delete from urun where u_id=" + id;
